...
def decoder(text):#coverts word into array
...
#HPYER PARAMETERS##Find combination for max accuracy
HP_VOCABSIZE =10000
HP_EmbedVectors = 16
HP_DenseVectors = 16
HP_EPOCHS = 50##no of times it will work
...
model.add(keras.layers.Dense(16,activation=tf.nn.relu))#removes negative
model.add(keras.layers.Dense(1,activation=tf.nn.sigmoid))#probability distribution
